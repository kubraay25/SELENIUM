...
public class C01_Xpath {
    ...
    public static void main(String[] args) {
        ...
        /* (//*[@class='a-size-base a-color-base'])[11] --> Bu şekilde index kullanarak uniqe olarak WE
        ulaşabiliriz

        text kismi sadece bir tanedir. arama yaptiginda burayi seciyor hoca
        ...
        ******* //*[text()='Hybrid Bikes'] --> xpath ile locate alırken html kodlarında attribute name olmayan <tagname class=değeri>text()
        ...
        /* <span class="a-size-base a-color-base">hybrid bike</span> bu kisim locatordaki kisim */

        // attribute name olmadigi icin "@" ifadesini asagida koymadim
        // cunku text alicam sadece
